...
- Require approval before sending a message outside the current Slack thread, changing external records, or starting costly work unless the user explicitly requested that exact action.
